...
public class ProsjektController extends WriteableConsumerRestController<ProsjektResource> {
    ...
    public ProsjektController(
            ...
            ProsjektEventKafkaProducer prosjektEventKafkaProducer,
            ProsjektResponseKafkaConsumer prosjektResponseKafkaConsumer,
            FintFilterService odataFilterService,
            ProsjektRequestKafkaConsumer prosjektRequestKafkaConsumer) {
        super(cacheService, fintLinker, prosjektConfig, prosjektEventKafkaProducer, prosjektResponseKafkaConsumer, odataFilterService, prosjektRequestKafkaConsumer);
    }
}
